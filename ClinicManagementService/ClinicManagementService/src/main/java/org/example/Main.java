...
public class Main {
    ...
    public static void testAddOperation() {
        ...
        DatabaseController.insertTreatment(new Treatment(1, "General Checkup", "General health checkup"));
        System.out.println("Operation added successfully.");
    }
    public static void testAddMedicalRecord() {
        MedicalRecordController medicalRecordController = new MedicalRecordController();
        Treatment treatment = new Treatment("General Checkup", "General health checkup");
